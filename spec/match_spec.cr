...
it "Identical" do
  e = HaveFiles::Expectation.new(__DIR__ + "/match/identical/expected")
  e.match(__DIR__ + "/match/identical/actual").should be_true
end

it "Not Identical" do
  e = HaveFiles::Expectation.new(__DIR__ + "/match/not_identical/expected")
...
it "Empty" do
  HaveFiles.tmpdir do |expected_dir|
    HaveFiles.tmpdir do |actual_dir|
      e = HaveFiles::Expectation.new(expected_dir)
...
it "Not Empty vs Empty" do
  HaveFiles.tmpdir do |actual_dir|
    e = HaveFiles::Expectation.new(__DIR__ + "/match/not_empty_vs_empty/expected")
